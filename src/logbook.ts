...
export interface ReadWorkContextOptions {
  ...
  // Preferred internal naming for which re-entry surface to expose.
  surface?: "brief" | "full";
  // Legacy internal alias retained for benchmark and migration compatibility.
  // Prefer `surface: "brief"` in new code.
  compact?: boolean;
}
